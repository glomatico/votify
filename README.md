...
| **Spotify DLL** | Extract from the Spotify for Windows desktop app version 1.2.88.472 inside its installation directory (Spotify.dll) | Required for desktop session |
