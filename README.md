...
| **Spotify DLL** | Extract the file Spotify.dll from the Spotify for Windows desktop app version 1.2.88.483 inside its installation directory | Required for desktop session |
